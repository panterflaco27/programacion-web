...
//la funcion se invoca cuando se presiona el boton "buscar"
function botonPresionado(){
    //obtener el campo de texto de entrada
    var valEntrada = document.getElementById("valEntrada");

    //obtener el parrafo de resultado
    var resultado = document.getElementById("resultado");

    //obtener la clave de busqueda del campo de texto de entrada y luego realizar la busqueda
...
}//fin de la funcion botonPresionado
