...
function porId(){
    var id = document.getElementById("gbi").ariaValueMax;
...
// reemplazar el nodo actual seleccionado como un nodo párrafo
function reemplazarActual(){
    ...
    cambiarA(nuevoNodo);
} // din de la función reemplazarActual

// eliminar el nodo actual
function eliminar(){
    if(nodoActual.parentNode == document.body){
        alert("No se puede eliminar un elementode nivel superior.");
    }else{
